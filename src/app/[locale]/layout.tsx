...
import { defaultOgImage, localeUrl } from "@/lib/seo";
...
export const generateMetadata = async ({
  ...
  return {
    // metadataBase is inherited from the root layout (src/app/layout.tsx).
    ...
    // Favicon and icons (files live in public/); the manifest is generated by
    // src/app/manifest.ts.
    ...
    // Declaring `openGraph` here replaces the one Next builds from
    // app/opengraph-image.tsx, so og:image has to be restated (see lib/seo.ts).
    openGraph: {
...
const LocaleLayout = async ({
  ...
  const clientMessages = Object.fromEntries(
    (["nav", "theme", "work", "contact", "status", "certifications", "fileViewer", "cv"] as const)
  ...
  return (
    ...
    >
      <body className="min-h-screen">
        <JsonLd data={[personSchema(locale, description), websiteSchema(locale, description)]} />
